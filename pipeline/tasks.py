...
frontend_task = Task(
    description=(
        ...
        "  4. Save the file to the correct path inside: {vercel_project_path}/app/\n"
        "     e.g. assignments page → {vercel_project_path}/app/assignments/page.tsx\n"
        "  5. Every file must be 100% complete — no '...', no 'TODO', no placeholders.\n"
        "  6. Handle loading states and empty states in the UI.\n"
        "\n"
        "CRITICAL NEXT.JS RULES — ALWAYS FOLLOW:\n"
        "  - NEVER edit or overwrite app/layout.tsx. It already exists and is correct.\n"
        "  - NEVER edit or overwrite app/components/Sidebar.tsx. It already exists.\n"
